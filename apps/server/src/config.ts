...
const envSchema = z.object({
  ...
  OFI_ROLLING_WINDOW_30_SECONDS: z.coerce.number().positive().default(600),
  ...
  STOP_LOSS_POLL_MS: z.coerce.number().int().min(100).default(1_000),
  BREAKOUT_POLL_MS: z.coerce.number().int().min(100).default(1_000),
  ORDERBOOK_STALE_MS: z.coerce.number().int().min(100).default(3_000),
  ...
  POLYMARKET_FETCH_TIMEOUT_MS: z.coerce.number().int().min(500).default(5_000),
  POLYMARKET_ORDERBOOK_TIMEOUT_MS: z.coerce.number().int().min(500).default(3_000),
  POLYMARKET_ORDER_SUBMIT_TIMEOUT_MS: z.coerce.number().int().min(500).default(5_000),
  API_ROUTE_TIMEOUT_MS: z.coerce.number().int().min(1_000).default(8_000),
