...
const envSchema = z.object({
  ...
  STOP_LOSS_POLL_MS: z.coerce.number().int().min(100).default(500),
  BREAKOUT_POLL_MS: z.coerce.number().int().min(100).default(1_000),
  ORDERBOOK_STALE_MS: z.coerce.number().int().min(100).default(3_000),
  ORDERBOOK_STALE_MS_NORMAL: z.coerce.number().int().min(100).default(1_000),
  ORDERBOOK_STALE_MS_FAST: z.coerce.number().int().min(100).default(500),
